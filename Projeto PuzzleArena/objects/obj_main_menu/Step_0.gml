...
var _select = keyboard_check(vk_enter) or keyboard_check(vk_space) or gamepad_button_check(0, gp_face1);
...
if (_select) {
    switch (index) {
        case 0:
            ...
            break;
        case 1:
			instance_create_layer(room_width/2, room_height/2, "Instances", obj_settings_menu)
            break;
        case 2:
            game_end();
            break;
